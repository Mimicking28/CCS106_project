...
Route::group(['namespace' => 'App\Http\Controllers'], function()
{
    ...
    Route::prefix('dashboard')->middleware( ['auth'] )->group(function ()
    {
        ...
        Route::prefix('/enrollment')->group(function(){
            Route::get('/add',          [EnrollmentController::class, 'create']);
            Route::post('/add',         [EnrollmentController::class , 'store'])->name('enrollment');
            Route::get ('/list',        [EnrollmentController::class , 'list']);
            Route::get ('/delete/{id}', [EnrollmentController::class , 'destroy']);
        });
